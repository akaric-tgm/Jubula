...
/**
 * Diese Methode implementiert eine Methode für das Multiplizieren und implementiert neben bei das Interface Operation
 * 
...
public class Multiplikation implements Operation {
	 ...
	 * Die Methode processCalculations hat als Parameter eine Liste aus zahlen die mit dem modifier multipliziert wird
	 * @param values eine Liste von Zahlen die mit dem modifier multipliziert wird und ein neues Ergebnis liefert 
	 * welches in die Liste zurück geschrieben wird und das alte Ergebniss ersetzt
	 * @param modifier der mit den Zahlen der Liste multiplizier wird
